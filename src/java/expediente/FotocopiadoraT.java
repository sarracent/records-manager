...
import beans.Fotocopiadora;
import beans.FotocopiadoraFacade;
...
public class FotocopiadoraT {
    ...
    PdfPTable tableImpresora = new PdfPTable(1);
        ...
        PdfPCell cellHDD = new PdfPCell(new Paragraph("Fotocopiadora", getFont("Arial", 9, 1, BLACK)));
    ...
    public PdfPTable valor(Computadora comp,FotocopiadoraFacade fotocopiadoraFacade ) {
        ...
        Collection<Fotocopiadora> col = new LinkedList<>();
//col.clear();
        
        col.addAll(fotocopiadoraFacade.ListaFotocopiadora(comp.getId()));

        for (Fotocopiadora fot : col) {
        //marca RAM
        PdfPCell cellImpresoraMarcaValue = new PdfPCell(new Paragraph(fot.getMarca(), getFont("Arial", 9, BLACK)));
        ...
        //modelo RAM
        PdfPCell cellImpresoramodeloValue = new PdfPCell(new Paragraph(fot.getModelo(), getFont("Arial", 9, BLACK)));
        ...
        // n/s ram
        PdfPCell cellImpresoraNSValue = new PdfPCell(new Paragraph(fot.getNoSerie(), getFont("Arial", 9, BLACK)));
        ...
        // n/s ram
        PdfPCell cellImpresoraNoInvValue = new PdfPCell(new Paragraph(fot.getNoInventario()+"", getFont("Arial", 9, BLACK)));
